...
class ProductController extends Controller
{
    public function index(){
        ...
        return view('seller.pages.product.index',compact('products'));
    }

    public function create()
    {
        $categories = Category::where('status',1)->get();
        return view('seller.pages.product.create')->with(compact('categories'));
    }
    ...
    public function edit($id){
        ...
        $categories = Category::where('status',1)->get();
        return view('seller.pages.product.edit', compact('categories','product'));
    }
    ...
    public function published($id)
    {
        ...
        $product->save();
        return redirect()->route('seller.product.index')->with('success', 'Product publish updated successfully.');
    }
}
