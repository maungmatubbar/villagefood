...
@section('main_content')
    ...
    <div class="card shadow mb-4  mx-auto">
        <div class="card-header d-sm-flex py-3  align-items-center justify-content-between">
            ...
            <a class="btn btn-outline-dark " href="{{ route('product.index') }}"><i
                    class="fa fa-arrow-alt-circle-left mr-1"></i>Back</a>
        </div>
        <div class="card-body">
            <form action="{{ route('product.update',['id'=>$product->id]) }}" method="post" enctype="multipart/form-data"> @csrf
                <div class="row">
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="is_approved" id="approved"
                                           value="1" {{ $product->is_approved?'checked':''}}>
                                    <label class="form-check-label" for="approved">Approved</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="is_approved" id="disapproved"
                                           value="0"  {{ !$product->is_approved?'checked':''}}>
